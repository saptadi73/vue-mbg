...
const FieldOperationsView = () => import('@/views/FieldOperationsView.vue')
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'finance_manager'] },
    },
    {
    ...
    {
      path: '/accounting/journal-entries/:journalEntryId',
    ...
    },
    {
      ...
      component: WorkflowApprovalsView,
      meta: {
        requiresAuth: true,
        roles: ['super_admin', 'tenant_admin', 'finance_manager', 'operations_manager'],
      },
    ...
    },
    {
      ...
      component: IntegrationPlatformOpsView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin'] },
    },
    {
      path: '/government-claims',
      name: 'government-claims',
      component: GovernmentClaimsView,
      meta: {
        requiresAuth: true,
        roles: ['super_admin', 'tenant_admin', 'finance_manager', 'operations_manager'],
      },
    ...
    {
      path: '/government-claims/:claimId',
      name: 'government-claim-detail',
      component: GovernmentClaimDetailView,
      meta: {
        requiresAuth: true,
        roles: ['super_admin', 'tenant_admin', 'finance_manager', 'operations_manager'],
      },
    },
    {
      path: '/funding',
      name: 'funding',
      component: FundingAgreementsView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'finance_manager'] },
    },
    {
      path: '/funding/agreements/:agreementId',
      name: 'funding-agreement-detail',
      component: FundingAgreementDetailView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'finance_manager'] },
    },
    {
      path: '/procurement',
    ...
    },
    {
      ...
      component: GoodsReceiptDetailView,
      meta: {
        requiresAuth: true,
        roles: [
          'super_admin',
    ...
    {
      path: '/procurement/supplier-invoices/:supplierInvoiceId',
      name: 'supplier-invoice-detail',
      component: SupplierInvoiceDetailView,
      meta: {
        requiresAuth: true,
        roles: [
          'super_admin',
    ...
    {
      path: '/procurement/supplier-payments/:supplierPaymentId',
      name: 'supplier-payment-detail',
      component: SupplierPaymentDetailView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'finance_manager'] },
    },
    {
    ...
    {
      path: '/production-orders/:productionOrderId/cost-sheet',
      name: 'production-order-cost-sheet',
      component: ProductionCostSheetDetailView,
      meta: {
        requiresAuth: true,
        roles: ['super_admin', 'tenant_admin', 'finance_manager', 'operations_manager'],
      },
    },
    {
      ...
      name: 'fleet',
      component: FleetView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
    ...
    {
      path: '/fleet/driver-tracker',
      name: 'fleet-driver-tracker',
      component: FleetDriverTrackerView,
      meta: { bareLayout: true },
    },
    {
      path: '/field-operations',
      name: 'field-operations',
      component: FieldOperationsView,
      meta: {
        requiresAuth: true,
        roles: [
          'super_admin',
    ...
    },
    {
      ...
      component: QualityInspectionsView,
      meta: {
        requiresAuth: true,
    ...
    {
      path: '/quality/food-safety',
      name: 'food-safety-traceability',
      component: FoodSafetyTraceabilityView,
      meta: {
        requiresAuth: true,
        roles: ['super_admin', 'tenant_admin', 'operations_manager', 'quality_officer'],
      },
    ...
    },
    {
      ...
      component: BeneficiaryDetailView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/positions',
      name: 'workforce-positions',
      component: WorkforcePositionsView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/employees',
      name: 'workforce-employees',
      component: WorkforceEmployeesView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/employees/create',
      name: 'workforce-employee-create',
      component: WorkforceEmployeeCreateView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/employees/:employeeId',
      name: 'workforce-employee-detail',
      component: WorkforceEmployeeDetailView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/shifts',
      name: 'workforce-shifts',
      component: WorkforceShiftsView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/attendance',
      name: 'workforce-attendance',
      component: WorkforceAttendanceView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/workforce/timesheets',
      name: 'workforce-timesheets',
      component: WorkforceTimesheetsView,
      meta: {
        requiresAuth: true,
    ...
    { path: '/sppg', name: 'sppg', component: SppgListView, meta: { requiresAuth: true } },
    {
      path: '/sppg/create',
      name: 'sppg-create',
      component: SppgCreateView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/sppg/:sppgId',
      name: 'sppg-detail',
      component: SppgDetailView,
      meta: { requiresAuth: true },
    },
    {
      path: '/sppg/:sppgId/edit',
      name: 'sppg-edit',
      component: SppgEditView,
      meta: { requiresAuth: true, roles: ['super_admin', 'tenant_admin', 'operations_manager'] },
    },
    {
      path: '/tenants',
