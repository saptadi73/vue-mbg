...
export const mockInventoryWarehouses: InventoryWarehouseRecord[] = [
  {
    id: 'wh-main-1',
    ...
    location: 'Area Distribusi Dapur - Zone A',
    is_active: true,
  },
  {
    id: 'wh-main-2',
    ...
    location: 'Area Distribusi Dapur - Zone B',
    is_active: true,
  },
  {
    id: 'wh-main-3',
    ...
    sppg_id: null,
    code: 'WH-DRY-02',
    name: 'Gudang Kering Utama',
    warehouse_type: 'DRY_STORAGE',
    location: 'Area Distribusi Dapur - Zone C',
    is_active: true,
  },
]

export const mockInventoryLocations: InventoryLocationRecord[] = [
  { id: 'loc-1', tenant_id: 'tenant-demo-mbg', warehouse_id: 'wh-main-1', sppg_id: null, parent_id: null, code: 'COLD-STG-A', name: 'Cold Storage A', location_type: 'COLD_STORAGE', is_active: true },
  { id: 'loc-2', tenant_id: 'tenant-demo-mbg', warehouse_id: 'wh-main-1', sppg_id: null, parent_id: 'loc-1', code: 'COLD-STG-A-RK-01', name: 'Rak A1', location_type: 'RACK', is_active: true },
  { id: 'loc-3', tenant_id: 'tenant-demo-mbg', warehouse_id: 'wh-main-2', sppg_id: null, parent_id: null, code: 'DRY-STG-B', name: 'Dry Storage B', location_type: 'DRY_STORAGE', is_active: true },
  { id: 'loc-4', tenant_id: 'tenant-demo-mbg', warehouse_id: 'wh-main-3', sppg_id: null, parent_id: null, code: 'DRY-STG-C', name: 'Dry Storage C', location_type: 'DRY_STORAGE', is_active: true },
]

export const mockInventoryTransactions: InventoryTransactionRecord[] = [
  {
    id: 'trx-1',
    tenant_id: 'tenant-demo-mbg',
    sppg_id: null,
    ...
    posted_by: 'procurement_officer',
    notes: 'Penerimaan awal ayam fillet.',
  },
  {
    id: 'trx-2',
    tenant_id: 'tenant-demo-mbg',
    ...
    batch_id: 'batch-5',
    source_warehouse_id: 'wh-main-3',
    destination_warehouse_id: 'wh-main-2',
    source_location_id: 'loc-4',
    destination_location_id: 'loc-3',
    quantity: 40,
    uom_id: 'kg',
    unit_cost: 14500,
    total_cost: 580000,
    transaction_at: '2026-07-20T13:35:00Z',
    posted_by: 'warehouse_operator',
    notes: 'Redistribusi internal antar gudang.',
  },
]
...
export const mockRoiBySppg: RoiBySppgRecord[] = [
  {
    sppg_id: 'sppg-jakarta-pusat-01',
    sppg_code: 'SPPG-JKT01',
    sppg_name: 'SPPG Jakarta Pusat 01',
    accepted_portions: 1480,
    received_portions: 1465,
    delivery_orders: 18,
    recognized_revenue: 18400000,
    cash_collected: 6200000,
    production_cost: 15140000,
    total_cost: 15320000,
    financing_cost: 180000,
    gross_surplus: 3080000,
    roi_percent: 20.1,
  },
  {
    sppg_id: 'sppg-tanah-abang-02',
    sppg_code: 'SPPG-JKT02',
    sppg_name: 'SPPG Tanah Abang 02',
    accepted_portions: 1210,
    received_portions: 1198,
    delivery_orders: 14,
    recognized_revenue: 14200000,
    cash_collected: 5100000,
    production_cost: 12610000,
    total_cost: 12750000,
    financing_cost: 140000,
    gross_surplus: 1450000,
    roi_percent: 11.4,
  },
  {
    sppg_id: 'sppg-bandung-01',
    sppg_code: 'SPPG-BDG01',
    sppg_name: 'SPPG Bandung 01',
    accepted_portions: 870,
    received_portions: 860,
    delivery_orders: 10,
    recognized_revenue: 9600000,
    cash_collected: 3200000,
    production_cost: 8980000,
    total_cost: 9100000,
    financing_cost: 120000,
    gross_surplus: 500000,
    roi_percent: 5.5,
  },
]
